...
# Paths and Filenames
MODEL_PATH = os.path.join('fall_detection','trained_models','YOLO_last.pt') #'path to trained model'
VIDEO_PATH =  os.path.join('sample_files','fall-02-cam0.mp4') #'path/to/your/video.mp4'
